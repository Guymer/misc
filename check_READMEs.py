...
if __name__ == "__main__":
    ...
    with open(f"{os.path.dirname(os.path.realpath(__file__, strict = True))}/Python 3.13 Standard Modules.json", mode = "rt", encoding = "utf-8") as fObj:
    ...
    # installation names ...
    python2pip = {
           "cartopy" : "cartopy >= 0.26.0",                                     # "**kwargs" was added to "background_img()"; cache clashes are avoided; Thunderforest tiles were added.
    ...
    for rname in sorted(glob.glob("*/README.md")):
        ...
        if os.path.exists(mname):
            with open(mname, mode = "rt", encoding = "utf-8") as fObj:
                for line in fObj:
        ...
        for pname in pyguymer3.return_file_list(
            ...
            with open(pname, mode = "rt", encoding = "utf-8") as fObj:
                for line in fObj:
        ...
        with open(f"{dname}/requirements.txt", mode = "wt", encoding = "utf-8") as fObj:
            # Write header ...
        ...
        # Load README ...
        with open(rname, mode = "rt", encoding = "utf-8") as fObj:
